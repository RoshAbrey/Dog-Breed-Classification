...
my_model.save('TESTING-MODEL.h5', overwrite=True) 
my_model.save_weights('TESTING-MODEL-WEIGHTS.h5', overwrite=True)
...
workbook = convert_report2excel(
    workbook=workbook,
    report=report,
    sheet_name="baseline_withweights_9010"
)

workbook.save("classification_report_baselinewithweights_9010.xlsx")
